...
class CreateReservacoormunicipalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reservacoormunicipals', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('reservacoormunicipals');
    }
}
