  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <form id="form" action="{{route('report_coordinacionmunicipal_tipoorganizacion')}}" method="POST">
              @csrf
              <div class="card card-info">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select required name="tipoorganizacion_id"  class="form-control form-control-sm" style="width: 70%;">
...
<script type="text/javascript">
  $('#form').on('submit', function(e){
    ...
    url = "{{route('report_coordinacionmunicipal_tipoorganizacion')}}"
    $.ajax({
      url: url,
      type: 'post',
      data: datos,
