  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <form id="form" action="{{route('reporte_coordinacionmunicipal')}}" method="POST">
              @csrf
              <div class="card card-info">
                <div class="card-header">
                    Reporte por fechas (Personerías Jurídicas): Dirección de Coordinación Municipal.
                </div>
                <div class="card-body">
                  <!-- === -->
...
<script type="text/javascript">
  $('#form').on('submit', function(e){
    ...
    url = "{{route('reporte_coordinacionmunicipal')}}"
    $.ajax({
      url: url,
      type: 'post',
      data: datos,
