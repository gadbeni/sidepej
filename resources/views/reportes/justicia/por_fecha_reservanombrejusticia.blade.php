  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <form id="form" action="{{route('reporte_rnjusticia')}}" method="POST">
              @csrf
              <div class="card card-info">
                <div class="card-header">
                    Reporte por fechas (Reservas de Nombre): Secretaría Departamental de Justicia.
                </div>
                <div class="card-body">
                  <!-- === -->
