        ...
        <div class="col-md-12">
            <div class="card card-info">
                <div class="card-header">
                    Reserva de nombre coordinación municipal   
                    <div class="card-tools">
                      <form action="{{route('reservacoordinacionmunicipal.index')}}" method="GET">
                        <div class="input-group input-group-sm" style="width: 500px;">
                          @include('reservacoordinacionmunicipal.search')

                          @can('reservacoordinacionmunicipal.create')
                          <a href="{{ route('reservacoordinacionmunicipal.create') }}"><button type="button" class="btn btn-default" title="Crear reserva de nombre"><i class="fas fa-plus"></i></button></a>
                          @endcan
                        </div>
                      </form>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr
                              ...
                              <td style="width:115px">
                                @can('reservacoordinacionmunicipal.edit')
                                <a href="{{route('reservacoordinacionmunicipal.edit',$reserva->id)}}" class="btn btn-info @if($reserva->estadotramite_id == 2 || $reserva->fechafin < date('Y-m-d')) disabled @endif" title="Editar estado de reserva de nombre"><i class="fas fa-edit"></i>
                                </a>
                                @endcan
                                @can('reservacoordinacionmunicipal.destroy')
                            ...
                            @include('reservacoordinacionmunicipal.modal')
                            @empty
