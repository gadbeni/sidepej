		...
		<div class="col-md-8">
			<div class="card card-info">
				<div class="card-header">
					<h3 class="card-title">Registrar Reserva de Nombre: Secretaría Departamental de Justicia</h3>
				</div>

			<form action="{{route('reservajusticia.store')}}" method="POST">
				@csrf
				<div class="card-body">
					<!-- === -->
	...
	<script>
		$(function () {
			...
			//Inicializa combo heredado
			  ...
			  $.get('/sidepej/municipio/' + dep_id, function(data){
			    $('#municipio_id').empty();
